...
@php
    $widgets['before_content'] = [
        [
            ...
            'heading' => 'Cao Chung Đạt',
            'content' =>
                '
                Phiên bản: <span class="text-danger text-break">' .
                config('ophim.version') .
                '</span><br/>
                Trang chủ: <a href="https://www.facebook.com/caochungdat/">WEB PHIM</a><br/>
                Dữ liệu phim miễn phí: <a href="https://www.facebook.com/caochungdat/">Bí mật</a>
            ',
