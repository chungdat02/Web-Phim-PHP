					...
					<xsl:when test="kml:kml">
						<div id="description">
							...
							<p>
								...
								<a href="https://xemphim.dungkon.me" target="_blank">Phim hay mới cập nhật 2022</a>. It is used to provide location information to Google.
							</p>
							<p>
								Learn more about
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://xemphim.dungkon.me/sitemap.xml">&#8592; Sitemap Index</a>
							</p>
					...
					<xsl:otherwise>
						<div id="description">
							...
							<p>
								...
								<a href="https://xemphim.dungkon.me" target="_blank">Phim hay mới cập nhật 2022</a>. It is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on your website.
							</p>
							<p>
								Learn more about
