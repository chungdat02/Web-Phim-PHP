...
if(isset($_GET['showall'])) {
    ...
    $data = mysqli_query($conn, "SELECT * FROM `image` ORDER BY id DESC LIMIT " . $offset . "," . $items_per_page . "");
    $load = mysqli_num_rows($data);
}
    if(isset($_POST['clearlog'])) {
        mysqli_query($conn, "DELETE FROM image");
        mysqli_query($conn, "ALTER TABLE image AUTO_INCREMENT=1;");
        echo '<script>window.location.href=""</script>';
}
?>
<title>Thư viện ảnh - <?php echo $titlecp; ?></title>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Tất cả ảnh: <?php echo $row_count; ?>
                            <small>up vừa thôi :v</small>
                        </h2>
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="javascript:void(0);"><form action="" method="POST"><button type="submit" name="clearall" class="fztcp_sbutton">Xóa tất cả</button></form></a></li>
                        ...
                        <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
                            <?php while ($row = mysqli_fetch_array($data, MYSQLI_ASSOC)) : ?>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <a href="<?php echo $row['url'];?>" data-sub-html="img">
                                        <img class="img-responsive thumbnail" src="<?php echo $row['url'];?>">
                                    </a>
                                </div>
                            <?php endwhile; ?>
                        </div>
